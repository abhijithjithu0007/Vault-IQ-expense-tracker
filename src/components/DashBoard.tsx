...
const Dashboard = () => {
  return (
    <div>
      <div className="flex justify-between pl-5 pr-4 mt-5">
      ...
      <div className="flex h-screen bg-gray-100 w-full">
        ...
        <div className="flex-2 bg-white w-full">
          <div className="h-full flex flex-col justify-around items-center  rounded-lg">
